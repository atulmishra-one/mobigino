    ...
    $.fn.lightbox = function (options) {
        ...
        var plugin = {
            ...
            resizeImage: function () {
                ...
                wHeight = $(".lightbox").height() - opts.margin;
                wWidth = $(".lightbox").outerWidth(true) - opts.margin;
                ...
                plugin.image.width(iWidth).height(iHeight).css({
						'top': ($(".lightbox").height() - plugin.image.outerHeight()) / 2 + 'px',
						'left': ($(".lightbox").width() - plugin.image.outerWidth()) / 2 + 'px'
					}).show();
                plugin.locked = false;
            },
